...
class Ciudadano(TimeStampedModel):
    ...
    # Podría convertirse en una entidad independiente si se requieren varias
...
class TelefonoCiudadanoLegado(models.Model):
    """Resguardo de teléfonos retirados del padrón para evitar perder datos."""
    ...
    def __str__(self):
        return f"Teléfono legado de {self.ciudadano}"
